"""tracking_dog_31272 URL Configuration
...
admin.site.site_header = "Tracking Dog"
admin.site.site_title = "Tracking Dog Admin Portal"
admin.site.index_title = "Tracking Dog Admin"

# swagger
api_info = openapi.Info(
    title="Tracking Dog API",
    default_version="v1",
    description="API documentation for Tracking Dog App",
)
